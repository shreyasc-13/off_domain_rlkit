...
import numpy as np
from robot_manipulators import Reacher, ReacherObstacle, Pusher, Striker, Thrower
...
class ReacherObstacleBulletEnv(MJCFBaseBulletEnv):

  def __init__(self, render=False):
    self.robot = ReacherObstacle()
    MJCFBaseBulletEnv.__init__(self, self.robot, render)
