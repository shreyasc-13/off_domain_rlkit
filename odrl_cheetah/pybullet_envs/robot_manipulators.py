...
class Reacher(MJCFBasedRobot):
  ...
  def __init__(self):
    MJCFBasedRobot.__init__(self, 'assets/reacher.xml', 'body0', action_dim=2, obs_dim=9)
  ...
  def robot_specific_reset(self, bullet_client):
    ...
    #     self.np_random.uniform(low=-self.TARG_LIMIT, high=self.TARG_LIMIT), 0)
    #Shreyas edit ###############
    self.jdict["target_x"].reset_current_position(0.2, 0)
    self.jdict["target_y"].reset_current_position(0.2, 0)
    #############################
    ...
    #############################
    self.central_joint.reset_current_position(3*3.14/4., 0)
    self.elbow_joint.reset_current_position(0, 0)
  ...
  def calc_state(self):
    ...
    return np.array([
        ...
        self.theta_dot,
        self.gamma,
        self.gamma_dot,#Shreyas edit, remove hereon!!
        # self.fingertip.pose().xyz()[0], #x-coord
        # self.fingertip.pose().xyz()[1], #y-coord
    ])
...
class ReacherObstacle(MJCFBasedRobot):
  TARG_LIMIT = 0.27

  def __init__(self):
    MJCFBasedRobot.__init__(self, 'assets/reacher_obs.xml', 'body0', action_dim=2, obs_dim=9)
...
class Pusher(MJCFBasedRobot):
  ...
  def __init__(self):
    MJCFBasedRobot.__init__(self, 'assets/pusher.xml', 'body0', action_dim=7, obs_dim=55)
