...
real=pd.read_csv("/home/swapnil/DRL/offDyna/rlkit-master/rlkit/data/name-of-experiment/real5/progress.csv")
simoffline=pd.read_csv("/home/swapnil/DRL/offDyna/rlkit-master/rlkit/data/name-of-experiment/simoffline5/progress.csv")
simonline=pd.read_csv("/home/swapnil/DRL/offDyna/rlkit-master/rlkit/data/name-of-experiment/simonline5/progress.csv")
...
plt.subplot(1,2,1)
plt.title("Mean Returns Over num Real Samples", size="small");plt.xlabel("num real samples"); plt.ylabel("Returns Mean");
plt.plot(rx,ry,'-r')
plt.plot(snx,sny,'-g')
plt.plot(sfx,sfy,'-b')
plt.plot(sfx2,sfy2,'-c')
plt.subplot(1,2,2)
plt.title("Mean Returns Over Epochs", size="small"); plt.xlabel("epoches"); plt.ylabel("Returns Mean")
