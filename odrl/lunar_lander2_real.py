...
class LunarLander(gym.Env, EzPickle):
    ...
    def __init__(self, action_mean=1, action_std_dev=1):
        ...
        self._noise_mean, self._noise_std_dev= action_mean, action_std_dev
        self.reset()
    ...
    def step(self, action):
        ...
        action=action.copy()
        action[1] = action[1]+ np.random.normal(self._noise_mean, self._noise_std_dev)
        ...
        if not self.lander.awake:
            ...
            reward = +100
        # print("real", np.array(state),action)
